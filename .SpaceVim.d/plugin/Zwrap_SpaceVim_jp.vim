...
let g:_spacevim_mappings_space = {'!': ['Unite output/shellcmd -no-start-insert', 'コマンド実行'],
                          \  "'": ["call call(function('<SNR>92_open_default_shell'), [])", 'シェル'],
                          ...
                          \  ';': ['call feedkeys("\<Plug>CommentOperator")', 'comment operator'],
                          \  '<Tab>': ['try | b# | catch | endtry', '直前のバッファ'],
                          \  '?': ['Denite menu:CustomKeyMaps -input=[SPC]', 'マッピング'],
                          \  'B': {'name': '+Global-buffers'},
                          \  'T':
                          ...
                          \   'b': ['Unite vim_bookmarks', 'ブックマークを開く'],
