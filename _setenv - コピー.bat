...
setx Path "%APPROOT%;%APPROOT%\bin;%APPROOT%\usr\bin;%PYTHONPATH%;%PYTHONPATH%\Scripts;%VIMHOME%\bin;%VIMRUNTIME%;C:\Program Files\CMake\bin;C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\bin"
